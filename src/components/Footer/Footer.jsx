...
const Footer = () => {
  const LINKS = [
    ...
    {
      title: "Address",
      items: ["Banani, Dhaka", "info@trippie.com", "+880 1712-345678"],
    },
  ];
        ...
        <div className="grid grid-cols-1 justify-between gap-4 lg:grid-cols-2">
          <div>
            <div className="flex items-center gap-2 md:gap-4 mb-6">
              <img className="w-10 md:w-11 xl:w-12" src={logo} alt="logo-img" />
              <Link to="/">
                <Typography
                  variant="h4"
                  className="text-[#000000] md:text-3xl xl:text-4xl font-volkhov font-bold pt-1 md:pt-1.5"
                >
                  Trippie
                </Typography>
              </Link>
